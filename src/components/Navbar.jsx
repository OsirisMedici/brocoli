...
const Navbar = () => {
  return (
    <>
          <nav class="bg- border-gray-200 dark:border-gray-600 dark:bg-gray-900">
              ...
              <div id="mega-menu-full-dropdown" class="mt-1 border-gray-200 shadow-sm bg-gray-50 md:bg-gray-800 border-y dark:bg-gray-800 dark:border-gray-600">
